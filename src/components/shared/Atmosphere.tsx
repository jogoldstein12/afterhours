export function Atmosphere() {
    return (
      <div className="fixed inset-0 -z-10 overflow-hidden bg-nightclub pointer-events-none">
        {/* Smoke Layer 1 — tinted by the mode in play (--atmo-1), drifting slowly. */}
        <div className="absolute top-[-10%] left-[-10%] w-[120%] h-[120%] animate-smoke text-[hsl(var(--atmo-1)/0.22)] transition-colors duration-1000">
        ...
        {/* Smoke Layer 2 (opposite direction, --atmo-2). */}
        <div className="absolute bottom-[-10%] right-[-10%] w-[100%] h-[100%] animate-smoke [animation-duration:25s] [animation-delay:-5s] text-[hsl(var(--atmo-2)/0.3)] transition-colors duration-1000">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
